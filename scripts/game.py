...
class TronGame:
    def __init__(self):
        ...
        self.grid_height = self.screen.get_height()
        self.grid_width = self.screen.get_width()
        ...
        self.obs = np.zeros((8, self.grid_height, self.grid_width), dtype=np.float32) #crea una matriz de ceros con 8 niveles/dimensiones, y con ancho y alto del mapa ((1280, 720))
    ...
    def update_state(self):
        ...
        self.trail1.drawTrail(self.screen)
        self.trail2.drawTrail(self.screen)
